  ...
  [
    ...
    },
    {
      ...
      image: ActiveStorage::Blob.create_and_upload!(
        io: File.open(Rails.root.join('app/assets/images/technology_supports_web.jpg')), filename: 'technology_supports_web'
      )
    },
    {
    ...
    },
    {
      ...
      category: 'book',
      image: ActiveStorage::Blob.create_and_upload!(
        io: File.open(Rails.root.join('app/assets/images/principles_of_programming.jpg')), filename: 'principles_of_programming'
      )
    },
    {
